    ...
    >
      <div className="w-full h-full flex justify-center items-center relative">
        {/* kapsayıcı dısına tıkladııgmız taktırde clickoutside fonksıyonu tetıklenecek. */}
          <div className="w-2/3 h-3/5 bg-slate-500 rounded-3xl opacity-100 ">
          <OutsideClickHandler onOutsideClick={clickOutSide}>
            <div className="flex flex-col items-center justify-center">
              ...
              <form className="w-full h-full flex flex-col gap-y-10 justify-between items-center   text-[20px] p-5 text-white ">
                {/* task input start */}
